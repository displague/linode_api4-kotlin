...
import io.swagger.client.models.DomainRecord
...
class DomainsApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    */
    ...
    fun createDomain(body: Domain) : Domain {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun createDomainRecord(body: kotlin.Any, domainId: kotlin.Int) : DomainRecord {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/domains/{domainId}/records".replace("{"+"domainId"+"}", "$domainId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<DomainRecord>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as DomainRecord
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun deleteDomain(domainId: kotlin.Int) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/domains/{domainId}".replace("{"+"domainId"+"}", "$domainId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun deleteDomainRecord(domainId: kotlin.Int, recordId: kotlin.Int) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/domains/{domainId}/records/{recordId}".replace("{"+"domainId"+"}", "$domainId").replace("{"+"recordId"+"}", "$recordId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<kotlin.Any>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getDomain(domainId: kotlin.Int) : Domain {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getDomainRecord(domainId: kotlin.Int, recordId: kotlin.Int) : DomainRecord {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getDomainRecords(domainId: kotlin.Int, page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse2009 {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getDomains(page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse2008 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("page" to listOf("$page"), "page_size" to listOf("$pageSize"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    * @param body Information about the Domain to import. (optional)
    * @return Domain
    */
    @Suppress("UNCHECKED_CAST")
    fun importDomain(body: kotlin.Any) : Domain {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun updateDomain(body: Domain, domainId: kotlin.Int) : Domain {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun updateDomainRecord(body: DomainRecord, domainId: kotlin.Int, recordId: kotlin.Int) : DomainRecord {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
