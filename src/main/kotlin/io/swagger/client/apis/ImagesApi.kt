...
import io.swagger.client.models.ImagePrivate
...
class ImagesApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    * @param body Information about the Image to create. (optional)
    * @return ImagePrivate
    */
    @Suppress("UNCHECKED_CAST")
    fun createImage(body: kotlin.Any) : ImagePrivate {
        ...
        val response = request<ImagePrivate>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as ImagePrivate
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun deleteImage(imageId: kotlin.String) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/images/{imageId}".replace("{"+"imageId"+"}", "$imageId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getImage(imageId: kotlin.String) : ImagePrivate {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getImages(page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse20010 {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun updateImage(body: ImagePrivate, imageId: kotlin.String) : ImagePrivate {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
