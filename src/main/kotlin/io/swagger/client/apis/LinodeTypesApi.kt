...
import io.swagger.client.models.LinodeType
...
class LinodeTypesApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    */
    ...
    fun getLinodeType(typeId: kotlin.String) : LinodeType {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/linode/types/{typeId}".replace("{"+"typeId"+"}", "$typeId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<LinodeType>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as LinodeType
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getLinodeTypes() : InlineResponse20018 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
