...
import io.swagger.client.models.Body13
import io.swagger.client.models.Body14
import io.swagger.client.models.Body15
...
class NetworkingApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    */
    ...
    fun allocateIP(body: Body13) : IPAddress {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun assignIPs(body: Body14) : kotlin.Any {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getIP(address: kotlin.String) : IPAddress {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/networking/ips/{address}".replace("{"+"address"+"}", "$address"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<IPAddress>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getIPs() : InlineResponse20026 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getIPv6Pools(page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse20027 {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getIPv6Ranges(page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse20028 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("page" to listOf("$page"), "page_size" to listOf("$pageSize"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun shareIPs(body: Body15) : kotlin.Any {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun updateIP(body: IPAddress, address: kotlin.String) : IPAddress {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
