...
import io.swagger.client.models.InlineResponse20035
...
class RegionsApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    */
    ...
    fun getRegion(regionId: kotlin.String) : Region {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/regions/{regionId}".replace("{"+"regionId"+"}", "$regionId"),
        ...
        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Region
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getRegions() : InlineResponse20035 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
