...
import io.swagger.client.models.StackScript
...
class StackScriptsApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    */
    ...
    fun addStackScript(body: kotlin.Any) : StackScript {
        ...
        val response = request<StackScript>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as StackScript
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun deleteStackScript(stackscriptId: kotlin.String) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/linode/stackscripts/{stackscriptId}".replace("{"+"stackscriptId"+"}", "$stackscriptId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getStackScript(stackscriptId: kotlin.String) : StackScript {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getStackScripts(page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse20017 {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun updateStackScript(stackscriptId: kotlin.String, body: StackScript) : StackScript {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
