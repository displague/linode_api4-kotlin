...
import io.swagger.client.models.Body21
import io.swagger.client.models.Body22
import io.swagger.client.models.Body23
import io.swagger.client.models.Body24
import io.swagger.client.models.InlineResponse20016
import io.swagger.client.models.InlineResponseDefault
import io.swagger.client.models.Volume
...
class VolumesApi(basePath: kotlin.String = "https://api.linode.com/v4") : ApiClient(basePath) {
    ...
    */
    ...
    fun attachVolume(body: Body22, volumeId: kotlin.Int) : Volume {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/volumes/{volumeId}/attach".replace("{"+"volumeId"+"}", "$volumeId"),
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun cloneVolume(body: Body23, volumeId: kotlin.Int) : kotlin.Any {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/volumes/{volumeId}/clone".replace("{"+"volumeId"+"}", "$volumeId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun createVolume(body: Body21) : Volume {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun deleteVolume(volumeId: kotlin.Int) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/volumes/{volumeId}".replace("{"+"volumeId"+"}", "$volumeId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<kotlin.Any>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun detachVolume(volumeId: kotlin.Int) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/volumes/{volumeId}/detach".replace("{"+"volumeId"+"}", "$volumeId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<kotlin.Any>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVolume(volumeId: kotlin.Int, page: kotlin.Int, pageSize: kotlin.Int) : Volume {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getVolumes(page: kotlin.Int, pageSize: kotlin.Int) : InlineResponse20016 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("page" to listOf("$page"), "page_size" to listOf("$pageSize"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun resizeVolume(body: Body24, volumeId: kotlin.Int) : kotlin.Any {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/volumes/{volumeId}/resize".replace("{"+"volumeId"+"}", "$volumeId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<kotlin.Any>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun updateVolume(body: kotlin.Any, volumeId: kotlin.Int) : Volume {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
