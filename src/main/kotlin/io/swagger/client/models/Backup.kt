...
import io.swagger.client.models.BackupDisks
 ...
 * @param id The unique ID of this Backup. 
 * @param type This indicates whether the Backup is an automatic Backup or manual snapshot taken by the User at a specific point in time.  
 * @param status The current state of a specific Backup. 
 * @param created The date the Backup was taken. 
 * @param updated The date the Backup was most recently updated. 
 * @param finished The date the Backup completed. 
 * @param label A label for Backups that are of type `snapshot`. 
 * @param configs A list of the labels of the Configuration profiles that are part of the Backup.  
 * @param disks A list of the disks that are part of the Backup. */
data class Backup (
    ...
    val finished: java.time.LocalDateTime? = null,
    ...
    val configs: kotlin.Array<kotlin.String>? = null,
    /* A list of the disks that are part of the Backup.  */
    val disks: kotlin.Array<BackupDisks>? = null
) {
    ...
    */
    ...
    /**
    * The current state of a specific Backup.
    * Values: paused,pending,running,needsPostProcessing,successful,failed,userAborted
    */
