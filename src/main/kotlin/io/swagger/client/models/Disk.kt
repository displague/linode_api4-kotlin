...
/**
 *  
 * @param id This Disk's ID which must be provided for all operations impacting this Disk.  
 * @param label The Disk's label is for display purposes only.  
 * @param status A brief description of this Disk's current state. This field may change without direct action from you, as a result of operations performed to the Disk or the Linode containing the Disk.  
 * @param size The size of the Disk in MB. 
 * @param filesystem The Disk filesystem can be one of:    * raw - No filesystem, just a raw binary stream.   * swap - Linux swap area.   * ext3 - The ext3 journaling filesystem for Linux.   * ext4 - The ext4 journaling filesystem for Linux.   * initrd - initrd (uncompressed initrd, ext2, max 32 MB).  
 * @param created When this Linode was created. 
 * @param updated When this Linode was last updated.*/
data class Disk (
    ...
    val filesystem: Disk.Filesystem? = null,
    ...
    /**
    * A brief description of this Disk's current state. This field may change without direct action from you, as a result of operations performed to the Disk or the Linode containing the Disk. 
    * Values: ready,notReady,deleting
    */
    ...
    /**
    * The Disk filesystem can be one of:    * raw - No filesystem, just a raw binary stream.   * swap - Linux swap area.   * ext3 - The ext3 journaling filesystem for Linux.   * ext4 - The ext4 journaling filesystem for Linux.   * initrd - initrd (uncompressed initrd, ext2, max 32 MB). 
    * Values: raw,swap,ext3,ext4,initrd
    */
    enum class Filesystem(val value: kotlin.String){
