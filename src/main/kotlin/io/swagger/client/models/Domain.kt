 ...
 * @param id This Domain's unique ID 
 ...
 * @param status Used to control whether this Domain is currently being rendered.  
 ...
 * @param retrySec The interval, in seconds, at which a failed refresh should be retried. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value.  
 ...
 * @param expireSec The amount of time in seconds that may pass before this Domain is no longer authoritative. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value.  
 * @param refreshSec The amount of time in seconds before this Domain should be refreshed. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value.  
 * @param ttlSec \"Time to Live\" - the amount of time in seconds that this Domain's records may be cached by resolvers or other domain servers. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value. */
data class Domain (
    ...
    val status: Domain.Status? = null,
    /* A description for this Domain. This is for display purposes only.  */
    val description: kotlin.String? = null,
    /* Start of Authority email address. This is required for master Domains.  */
    val soaEmail: kotlin.String? = null,
    ...
    val retrySec: kotlin.Int? = null,
    /* The IP addresses representing the master DNS for this Domain.  */
    val masterIps: kotlin.Array<kotlin.String>? = null,
    /* The list of IPs that may perform a zone transfer for this Domain. This is potentially dangerous, and should be set to an empty list unless you intend to use it.  */
    val axfrIps: kotlin.Array<kotlin.String>? = null,
    /* The amount of time in seconds that may pass before this Domain is no longer authoritative. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value.  */
    val expireSec: kotlin.Int? = null,
    /* The amount of time in seconds before this Domain should be refreshed. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value.  */
    val refreshSec: kotlin.Int? = null,
    ...
    */
    ...
    /**
    * Used to control whether this Domain is currently being rendered. 
    * Values: disabled,active,editMode,hasErrors
    */
