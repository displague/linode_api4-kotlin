...
import io.swagger.client.models.EventEntity
 ...
 * @param action The action that caused this Event. New actions may be added in the future.  
 * @param created When this Event was created. 
 * @param entity  
 * @param percentComplete A percentage estimating the amount of time remaining for an Event. Returns `null` for notification events.  
 * @param rate The rate of completion of the Event. Only some Events will return rate; for example, migration and resize Events.  
 * @param read If this Event has been read. 
 * @param seen If this Event has been seen. 
 * @param status The current status of this Event. 
 * @param timeRemaining The estimated time remaining until the completion of this Event. This value is only returned for in-progress events.  
 * @param username The username of the User who caused the Event. */
data class Event (
    /* The unique ID of this Event. */
    val id: kotlin.Int? = null,
    /* The action that caused this Event. New actions may be added in the future.  */
    val action: Event.Action? = null,
    ...
    val percentComplete: kotlin.Int? = null,
    ...
    /**
    * The action that caused this Event. New actions may be added in the future. 
    * Values: backupsEnable,backupsCancel,backupsRestore,communityQuestionReply,creditCardUpdated,diskCreate,diskDelete,diskDuplicate,diskImagize,diskResize,dnsRecordCreate,dnsRecordDelete,dnsZoneCreate,dnsZoneDelete,imageDelete,linodeAddip,linodeBoot,linodeClone,linodeCreate,linodeDelete,linodeDeleteip,linodeMigrate,linodeMutate,linodeReboot,linodeRebuild,linodeResize,linodeShutdown,linodeSnapshot,longviewclientCreate,longviewclientDelete,managedDisabled,managedEnabled,managedServiceCreate,managedServiceDelete,nodebalancerCreate,nodebalancerDelete,nodebalancerConfigCreate,nodebalancerConfigDelete,passwordReset,paymentSubmitted,stackscriptCreate,stackscriptDelete,stackscriptPublicize,stackscriptRevise,tfaDisabled,tfaEnabled,ticketAttachmentUpload,ticketCreate,ticketUpdate,volumeAttach,volumeClone,volumeCreate,volumeDelete,volumeDetach,volumeResize
    */
    ...
    /**
    * The current status of this Event.
    * Values: failed,finished,notification,scheduled,started
    */
