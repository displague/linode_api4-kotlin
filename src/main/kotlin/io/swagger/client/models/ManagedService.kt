 ...
 * @param id This Service's unique ID.  
 * @param status The current status of this Service.  
 * @param serviceType How this Service is monitored.  
 * @param label The label for this Service. This is for display purposes only.  
 * @param address The URL at which this Service is monitored.  
 * @param timeout How long to wait, in seconds, for a response before considering the Service to be down.  
 * @param body What to expect to find in the response body for the Service to be considered up.  
 * @param consultationGroup The group of ManagedContacts who should be notified or consulted with when an Issue is detected.  
 * @param notes Any information relevant to the Service that Linode special forces should know when attempting to resolve Issues.  
 * @param region The Region in which this Service is located. This is required if address is a private IP, and may not be set otherwise.  
 * @param credentials An array of ManagedCredential IDs that should be used when attempting to resolve issues with this Service.  
 * @param created When this Managed Service was created. 
 * @param updated When this Managed Service was last updated.*/
data class ManagedService (
    /* This Service's unique ID.  */
    val id: kotlin.Int? = null,
    /* The current status of this Service.  */
    val status: ManagedService.Status? = null,
    /* How this Service is monitored.  */
    val serviceType: ManagedService.ServiceType? = null,
    ...
    val consultationGroup: kotlin.String? = null,
    ...
    val credentials: kotlin.Array<kotlin.Int>? = null,
    ...
    /**
    * The current status of this Service. 
    * Values: disabled,pending,ok,problem
    */
    ...
    * Values: uRL,tCP
    */
    enum class ServiceType(val value: kotlin.String){
