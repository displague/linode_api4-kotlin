...
import io.swagger.client.models.SupportTicketEntity
 ...
 * @param attachments A list of filenames representing attached files associated with this Ticket.  
 * @param closed The date and time this Ticket was closed.  
 * @param description The full details of the issue or question.  
 * @param entity  
 * @param gravatarId The Gravatar ID of the User who opened this Ticket.  
 * @param opened The date and time this Ticket was created.  
 * @param openedBy The User who opened this Ticket.  
 * @param status The current status of this Ticket. 
 * @param summary The summary or title for this Ticket.  
 * @param updated The date and time this Ticket was last updated.  
 * @param updatedBy The User who last updated this Ticket. */
data class SupportTicket (
    ...
    val closed: java.time.LocalDateTime? = null,
    /* The full details of the issue or question.  */
    val description: kotlin.String? = null,
    val entity: SupportTicketEntity? = null,
    ...
    val opened: java.time.LocalDateTime? = null,
    /* The User who opened this Ticket.  */
    val openedBy: kotlin.String? = null,
    /* The current status of this Ticket. */
    val status: SupportTicket.Status? = null,
